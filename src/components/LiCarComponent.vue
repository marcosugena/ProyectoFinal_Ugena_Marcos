<template>
    <div>
        <div class="containerli d-flex align-content-center justify-content-between align-items-center ">
            <img :src="imageurl" alt="" class="imgli">
            <li class="text-center w-25">{{name}}</li>
            <li>X{{Cantidad}}</li>
            <li class="d-flex flex-column"><img src="@/assets/mas.png" alt="" class="mb-1" @click="addproduct(name)"> <img src="@/assets/menos.png" alt="" class="mt-1" @click="minusproduct(name)"></li>
            <li>{{price}}€</li>
